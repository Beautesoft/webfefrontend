    ...
    return (
      <div className="view-detail container px-md-5">
        {/* <div className="d-flex align-items-center cursor-pointer" onClick={() => history.push('/admin/staff')}>
                    ...
                    <span className="fs-15 tc-primary pl-2">{t("Staffs")}</span>
               </div> */}
...
export const StaffDetails = withTranslation()(
  connect(mapStateToProps, mapDispatchToProps)(StaffDetailsClass)
);
