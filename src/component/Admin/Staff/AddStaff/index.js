    ...
    return (
      <div className="px-5 container create-staff">
        ...
        <div className="head-label-nav">
          <p className="category">{t("Staffs")} </p>
          <i className="icon-right mx-md-3"></i>
          <p className="sub-category">
            {t(
              "Add " + (this.props.match.params.id ? "Edit" : "New") + " Staff"
            )}
          </p>
        </div>
            ...
            <div className="col-md-12 p-0">
              ...
              {/*                             
                            <div className="d-flex flex-wrap image-upload">
                                <div className="p-0" >
                                    <label for="imageUpload" class="btn cursor-pointer">{t("Upload Image")}</label>
...
export const AddStaff = withTranslation()(
