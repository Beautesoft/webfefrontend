                    ...
                    <div className="py-4">
                        <div className="table-container">
                            <TableWrapper
                                ...
                                pageMeta={pageMeta}
                            >
                                {staffList.length > 0 ? staffList.map(({ id,
                                    emp_name,
                                    emp_phone1,
                                    emp_code,
                                    services,
                                    ...
                                    return (
                                        <tr key={index}>
                                            ...
                                            <td className="position-relative status-type"><span className={`${status === "available" ? 'available' : 'not-available'}`}></span><div className="d-flex align-items-center justify-content-center">{emp_name}</div></td>
                                            <td><div className="d-flex align-items-center justify-content-center">{emp_phone1}</div></td>
                                            <td><div className="d-flex align-items-center justify-content-center">{emp_code}</div></td>
                                            {/* <td><div className="d-flex align-items-center justify-content-center"></div></td> */}
                                            <td><div className="d-flex align-items-center justify-content-center">{services ? services[0]: ""}</div></td>
                                            <td><div className="d-flex align-items-center justify-content-center">{defaultsitecode}</div></td>
                                            <td><div className="d-flex align-items-center justify-content-center">{site_code}</div></td>
                                                ...
                                                {currentIndex === index ?
                                                    <>
                                                        ...
                                                        <div className="option card">
                                                            <div className="d-flex align-items-center fs-14 pt-3" onClick={() => this.props.history.push(`/admin/staff/${id}/staffDetails`)}><span className="icon-eye-grey px-3"></span> View </div>
                                                            <div className="d-flex align-items-center fs-14" onClick={() => this.props.history.push(`/admin/staff/${id}/editStaff`)}><span className="icon-edit px-3"></span> Edit </div>
                                                            <div className="d-flex align-items-center fs-14 pb-3" onClick={() => this.handleDeleteStaff(id)}><span className="icon-delete px-3"></span> Delete </div>
                                                        </div>
                                                    </>
                                                    : 
                                                    <div className="d-flex align-items-center justify-content-center horizontal-more"><i className="icon-more text-grey"></i></div>
                                                }
                                            </td>
                                        </tr>
                                    )
...
export const ListStaff = connect(mapStateToProps, mapDispatchToProps)(ListStaffClass)