    ...
    return (
      <div className="view-detail">
        <div
          ...
          onClick={() => history.push("/admin/salons")}
        >
          <i className="icon-left-arrow tc-primary fs-10"></i>
          <span className="fs-15 tc-primary pl-2">{t("Salons")}</span>
        </div>
        <h3 className="inner-head">{t("Salon Details")}</h3>
        <div className="view-detail-box p-4 d-flex flex-column">
          <div className="d-flex pb-3">
            <div className="col-6">
              <p className="fs-28 fw-500 salon-detail-heading py-2">
                {itemsite_desc}
              </p>
            ...
            <div className="col-6 icon-change">
              <button
                onClick={() => this.deleteSaloon(id)}
                className="btn outline-btn delete-btn mx-2 col-2 fs-15 float-right text-capitalize"
              >
                <span className="icon-delete mr-2"></span>
                {t("Delete")}
              </button>
              <button
                onClick={() => this.editSaloon(id)}
          ...
          <div className="beautesoft-navlink">
            <div className="filled-tabs">
              ...
              <TabContent activeTab={this.state.activeTab}>
                ...
                <TabPane tabId="2">
                  {this.state.activeTab === "2" ? <StaffDetails /> : ""}
                </TabPane>

                <TabPane tabId="3">
                  {this.state.activeTab === "3" ? <CustomerList /> : ""}
                </TabPane>

                <TabPane tabId="4">
                  {this.state.activeTab === "4" ? <ProductSaleHistory /> : ""}
                </TabPane>
              </TabContent>
            </div>
          </div>
...
export const SalonDetails = withTranslation()(
  connect(mapStateToProps, mapDispatchToProps)(SalonDetailsClass)
);
