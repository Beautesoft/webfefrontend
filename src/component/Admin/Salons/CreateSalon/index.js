...
// select image to formfield
    ...
    render() {
        let { formFields, locationOption, skillsOptions, selectedSkills } = this.state;

        let { salonName, openingDate, branch, services, contactNumber, email, images, description } = formFields;
        return (
                ...
                <div className="salon-detail">
                        ...
                        <div className="row">
                            ...
                            <div className="col-6">
                                ...
                                <div className="input-group">
                                    ...
                                    {!this.props.match.params.id ? (skillsOptions.length > 0 ? <NormalMultiSelect name="skills" className={`staff-skills-select ${services !== "" ? "overflow-y-set" : ""}`} options={skillsOptions} handleMultiSelect={this.handleMultiSelect}></NormalMultiSelect> : "") : (
                                        skillsOptions.length > 0 && selectedSkills.length > 0 ? <NormalMultiSelect name="skills" value={selectedSkills.length > 0 ? selectedSkills : []} className={`staff-skills-select ${services !== "" ? "overflow-y-set" : ""}`} options={skillsOptions} handleMultiSelect={this.handleMultiSelect}></NormalMultiSelect> : ""
                                    )
                                    }
                                </div>
                    ...
                    <div className="form-group mb-4 pb-2">
                        <div className="row">
                            <div className="col-6">
                                ...
                                {this.validator.message('contactNumber', contactNumber, 'required|min:8|max:8')}
                            </div>
                            <div className="col-6">
                                <label className="text-left text-black common-label-text fs-17 pb-3">
                                    Email Address
                    ...
                    <div className="form-group mb-4 pb-2">
                        ...
                        <div className="col-md-12 p-0">
                            ...
                            {!this.props.match.params.id ? this.validator.message('Emp_PIC', images, 'required') : ""}
                        </div>
                    </div>
...
export const CreateSalon = connect(mapStateToProps, mapDispatchToProps)(CreateSalonClass)