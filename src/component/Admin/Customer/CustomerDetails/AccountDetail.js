                ...
                <div className="view-detail-box p-4 d-flex flex-column">
                    <div className="d-flex pb-3">
                        ...
                        <div className="col-6 icon-change menu-list">
                            ...
                            <button className={`btn outline-btn col-2 mx-2 fs-14 float-left text-capitalize detail`} onClick={() => history.push(`/admin/customer/${this.props.match.params.id}/details`)}>
                                Detail
                            </button>
                            <button className={`btn outline-btn col-2 mx-2 fs-14 active float-left text-capitalize account`} onClick={() => history.push(`/admin/customer/${this.props.match.params.id}/account`)}>
                                Account
                            </button>
...
export const AccountDetails = connect(mapStateToProps, mapDispatchToProps)(AccountDetailsClass)