...
class LogsClass extends React.Component {
  state = {
    log: [
      {
  ...
  render() {
    ...
    return (
      <>
        <h3 className="team-label my-4">{t("Logs")}</h3>
        <div className="logs">
          <div className="card">
            <p className="label">{t("Activities log")}</p>
            <div className="my-4">
              {log &&
                log.map((data, index) => (
...
export const Logs = withTranslation()(LogsClass);
