...
class StaffServicesClass extends React.Component {
  state = {
    formFields: {
      staffmonth: "",
      servicemonth: "",
        ...
        <div className="row staff-service">
          ...
          <div className="col-6">
            <div className="card">
              ...
              <div className="staff-service-label text-center">
                <i className="icon-bookmark"></i>
                <p>{t("Total number of Customers")}</p>
                <h1>5,000</h1>
              </div>
            </div>
          </div>
...
export const StaffServices = withTranslation()(StaffServicesClass);
