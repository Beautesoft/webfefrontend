...
class IncomeStatsClass extends React.Component {
  state = {
    formFields: {
      staffmonth: "",
      servicemonth: "",
  ...
  render() {
    ...
    let { staffmonth, staffmonthOption, servicemonth, servicemonthOption } =
      ...
      <div className="staffs-services-holder">
        <div className="row staff-service">
          <div className="col-6">
            <div className="card">
              <div className="d-flex justify-content-between align-items-center mb-3">
                <p className="staffs">{t("Services")}</p>
              ...
              <div className="staff-service-label text-center">
                ...
                <p>{t("Total number of Services completed")}</p>
                <h1>75,000</h1>
              </div>
            </div>
          </div>
          <div className="col-6">
            <div className="card">
              <div className="d-flex justify-content-between align-items-center mb-3">
                <p className="services">{t("Products")}</p>
                <div className="line-chart-year">
                  <NormalSelect
              ...
              <div className="staff-service-label text-center">
                <i className="icon-bookmark"></i>
                <p>{t("Total number of Products Sold")}</p>
                <h1>5,000</h1>
              </div>
            </div>
          </div>
...
export const IncomeStats = withTranslation()(IncomeStatsClass);
