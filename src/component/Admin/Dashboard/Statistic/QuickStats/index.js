    ...
    return (
      <div className="quickStats">
        <div className="d-flex align-items-center mb-4">
          <h3 className="team-label w-100">{t("Quick stats")}</h3>
...
export const QuickStats = withTranslation()(
  connect(null, mapDispatchToProps)(QuickStatsClass)
);
