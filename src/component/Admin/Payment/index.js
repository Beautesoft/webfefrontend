...
export class PaymentClass extends Component {
  state = {
    ...
    product: [
      {
        img: Brush,
        productName: "L'Oreal Paris Makeup Brush",
        category: "This is a gift",
        color: "#000",
        cost: "$7.97",
      },
      {
                    ...
                    product.map((data, index) => (
                      <div className="product-list" key={index}>
                        ...
                        <div className="product-color">
                          <p className="color-label">{t("Color")}</p>
                          <p
                            style={{
                              width: "31px",
                              height: "31px",
                        ...
                        <div className="size-selector">
                          <p className="size-label">{t("Size")}</p>
                          <select>
                            <option>{t("1")}</option>
                            <option>{t("2")}</option>
                            <option>{t("3")}</option>
              ...
              <div className="cart-total">
                <div className="cart-price">
                  <div className="row pb-3">
                    <div className="col-7">
                      <p className="fs-16">{t("Subtotal")}</p>
                    </div>
                    <div className="col-5">
                      <p>${responseData.subtotal}</p>
                    </div>
                  </div>
                  <div className="row pb-3">
                    <div className="col-7">
                      <p className="fs-16">{t("Discount")}</p>
                    </div>
                    <div className="col-5">
                      <p>${responseData.discount}</p>
                    </div>
                  </div>
                  <div className="row pb-3">
                    <div className="col-7">
                      <p className="fs-16">{t("Transaction Amount")}</p>
                    </div>
                    <div className="col-5">
                      <p>${responseData.trans_amt}</p>
                    </div>
                  </div>
                  <div className="row pb-3">
                    <div className="col-7">
                      <p className="fs-16">{t("Deposit")}</p>
                    </div>
                    <div className="col-5">
                      <p>${responseData.deposit_amt}</p>
                    </div>
                  </div>
                  <div className="row pb-3">
                    <div className="col-7">
                      <p className="fs-16">{responseData.tax_lable}</p>
                    </div>
                    <div className="col-5">
                      <p>${responseData.tax_amt}</p>
                    </div>
                  </div>
                </div>
                <div className="text-center">
                  <p className="fs-18">{t("Billable amount")}</p>
