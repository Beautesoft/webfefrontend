...
export class MakePaymentClass extends Component {
  ...
  getPayment = () => {
    ...
    if (selected_cstomer) {
      this.props
        .getPayment(
          `?sitecodeid=${selected_cstomer.branchId}&cart_date=${dateFormat(
            new Date(),
            "yyyy-mm-dd"
          )}&cust_noid=${selected_cstomer.cust_noid}&cart_id=${this.props.id}`
        )
        .then((res) => {
          ...
          <div className="row pl-3">
            ...
            <div className="col-5">
              <div class="radio-item">
                ...
                />
                <label for="creditOrDebit">{t("Credit / Debit card")}</label>
              </div>
              {creditOrDebit ? (
                <>
            ...
            <div className="col-5">
              <div class="radio-item">
                <input
                  ...
                  onClick={this.handleSelectOption}
                />
                <label for="prepaid">{t("Prepaid")}</label>
              </div>
              {prepaid ? (
                <>
                  <div className="input-group my-3">
            ...
            <div className="col-5">
              <div class="radio-item">
                <input
                  ...
                  onClick={this.handleSelectOption}
                />
                <label for="payOnPremise">{t("Pay on premise")}</label>
              </div>
              {payOnPremise ? (
                <>
                  <div className="input-group my-3">
            ...
            {/* <div className="col-5">
                            <h4 className="mb-4">{t("Add Discount")}/Vouchers</h4>
                            <div className="input-group">
                                <NormalInput
                                    value={address}
                                    name="address"
