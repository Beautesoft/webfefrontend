              ...
              <div className="row item-list-detail">
                <div className="col-9 list">
                  <div className="row my-2">
                    <div className="col-4 text-center">{t("Treatment")}</div>
                    <div className="col-2 text-center">{t("Cost")}</div>
                    <div className="col-2 text-center">{t("Quantity")}</div>
                ...
                <div className="col-3 billable-amount">
                  <div className="row">
                    ...
                    {/* <div className="col-6">{t("Voucher")}</div>
