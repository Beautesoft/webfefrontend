...
export class CartHomeClass extends Component {
  ...
  render() {
    let { navLinks, active, currentValue, branchList, customerList } =
      this.state;
    ...
    return (
      <>
        <div className="cart-section">
          <div className="row mt-2 mb-5 mx-3">
            <div className="col-10">
              ...
              <div className="pl-0 mt-3 fs-18 py-2">{t("Select Branch")}</div>
              <NormalSelect
                placeholder="select"
                options={branchList}
              ...
              />
              <div className=" pl-0 mt-3 fs-18 py-2">{t("Customer")}</div>
              <NormalInput
        ...
        >
          ...
          />
          <div className="row mt-2 mb-5 mx-3">
            <div className="col-12 pl-0 mt-3 fs-18 py-2">{t("Customer")}</div>
            <input
              // placeholder="Enter here"
              // options={siteList}
              value={selected_cstomer.cust_name}
            ...
            <div className="col-12 pl-0 mt-3 fs-18 py-2">{t("Search")}</div>
            <input
              // placeholder="Enter here"
              // options={siteList}
            ...
            <div className="row mt-4 table-header w-100 m-0">
              ...
              <div className="col-5">{t("Email")}</div>
            </div>
...
export const CartHome = withTranslation()(
  connect(mapStateToProps, mapDispatchToProps)(CartHomeClass)
);
