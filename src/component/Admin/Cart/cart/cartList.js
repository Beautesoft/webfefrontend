        ...
        <div className="treatment-section ml-1">
          ...
          <div className="row py-2 treatment-menu">
            <div className="col-2 ml-2 ">
              <div className="menus active">{t("Services")}</div>
            </div>
            <div className="col-2 ml-2">
              <div className="menus">{t("Products")}</div>
            </div>
            <div className="col-2 ml-2">
              <div className="menus">{t("Packages")}</div>
            </div>
            <div className="col-2 ml-2">
              <div className="menus">{t("Prepaid")}</div>
            </div>
            <div className="col-2 ml-2">
              <div className="menus">{t("Vouchers")}</div>
            </div>
          </div>
          {activeTab === "treatment" ? (
            <div className="services  row">
              <div className="service-tab col-3 m-2">
                ...
                <div className="title">{t("Facials")}</div>
              </div>
              <div className="service-tab col-3 m-2">
                <div className="images"></div>
                <div className="title">{t("Massages")}</div>
              </div>
              <div className="service-tab col-3 m-2">
                <div className="images"></div>
                <div className="title">{t("Facials")}</div>
          ...
          {activeTab === "treatmentList" ? (
            <div className="services  row">
              <div className="col-12">
                <p>
                  {t("Treatments")} {">"} {t("Facials")}
                </p>
              </div>
              <div className="service-tab col-3 m-2">
                <div className="images"></div>
          ...
          {activeTab === "treatmentDetail" ? (
            <div className="services  row">
              ...
              <div className="row m-2">
                <div className="col-8">
                  <p className="healine">{t("Treatment details")}</p>
                  <p className="description">
                    {t(`Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Lorem nunc lectus consequat amet, arcu. Tempus ante sodales
                    turpis facilisi ut sagittis sit ac habitasse. Hendrerit
                    nullam mi congue massa bibendum. Molestie posuere
                    pellentesque`)}
                  </p>
                </div>
                <div className="col-4">
              ...
              <div className="row m-2">
                <div className="col-8">
                  <p className="healine">{t("Procedure")}</p>
                  <p className="description">
                    {t(`Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Lorem nunc lectus consequat amet, arcu. Tempus ante sodales
                    tu`)}
              ...
              <div className="row m-2">
                <div className="col-8">
                  <p className="healine">{t("Products used")}</p>
                  <div className="input-group">
                    <NormalInput
                  ...
                  <p className="healine mt-4">{t("Recurring appointment")}</p>
                  <div className="input-group">
                    <NormalInput
