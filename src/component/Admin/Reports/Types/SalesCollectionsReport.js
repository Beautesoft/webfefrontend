...
class SalesCollectionsReportClass extends Component {
  state = {
    selectedSites: "",
    siteOptions: [],
    selectedSiteGroup: "",
    ...
    return (
      <div className="container-fluid report-types">
        <div className="row mb-4">
          <div className="col">
            <h3>{t("Sales Collections(Retail Products and Services)")}</h3>
          </div>
        </div>
...
export const SalesCollectionsReport = withTranslation()(
  connect(mapStateToProps, mapDispatchToProps)(SalesCollectionsReportClass)
);
