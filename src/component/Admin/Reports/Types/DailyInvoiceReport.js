...
class DailyInvoiceReportClass extends Component {
  state = {
    selectedSites: "",
    siteOptions: [],
    selectedSiteGroup: "",
...
export const DailyInvoiceReport = withTranslation()(
  connect(mapStateToProps, mapDispatchToProps)(DailyInvoiceReportClass)
);
