...
class StockMovementSummaryReportClass extends Component {
  state = {
    selectedSites: "",
    siteOptions: [],
    selectedSiteGroup: "",
    ...
    return (
      <div className="container-fluid report-types">
        <div className="row mb-4">
          <div className="col">
            <h3>{t("Stock Movement - Summary")}</h3>
          </div>
        </div>
...
export const StockMovementSummaryReport = withTranslation()(
  connect(mapStateToProps, mapDispatchToProps)(StockMovementSummaryReportClass)
);
