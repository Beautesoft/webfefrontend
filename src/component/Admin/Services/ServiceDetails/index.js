...
export class ServiceDetailsClass extends Component {
  ...
  render() {
    let { servicesDetail = {}, t } = this.props;
    ...
    return (
      <div className="view-detail">
        ...
        >
          ...
          <span className="fs-15 tc-primary pl-2">{t("Services")}</span>
        </div>
        <h3 className="inner-head">{t("Treatment Details")}</h3>
...
export const ServiceDetails = withTranslation()(
  connect(mapStateToProps, mapDispatchToProps)(ServiceDetailsClass)
);
