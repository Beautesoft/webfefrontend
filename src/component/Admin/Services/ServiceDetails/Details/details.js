    ...
    return (
      <div className="salon-details">
        <div className="pt-5 d-flex">
          <div className="col-3">
            <p className="salon-detail-desc pb-4">{t("Treatment Price")}</p>
            <p className="salon-detail-desc pb-4">{t("Service Tax")}</p>
            <p className="salon-detail-desc pb-4">{t("Discount")}</p>
            <p className="salon-detail-desc pb-4">{t("Suitable for")}</p>
            <p className="salon-detail-desc pb-4">{t("Description")}</p>
            <p className="salon-detail-desc py-2">{t("Treatment Images")}</p>
          </div>
          <div className="col-9">
        ...
        <div className="d-flex salon-detail-image pb-4">
          {images.length > 0
            ? images.map(({ id, image, item_sitelist, services }, index) => {
...
export const Details = withTranslation()(
  connect(mapStateToProps, null)(DetailsClass)
);
