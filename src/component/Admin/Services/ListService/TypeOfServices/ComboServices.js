            ...
            services.map((data, index) => (
              <div className="services" key={index}>
                    ...
                    {currentIndex == index ? (
                      <>
                        ...
                        <div className="option card">
                          <Link to="/admin/service/serviceDetails">
                          ...
                          <div className="d-flex align-items-center fs-16">
                            <span className="icon-edit px-3"></span> {t("Edit")}
                          </div>
                ...
                <div className="combo-total">
                  ...
                  <div className="col-5">
                    {t("Total Combo price")} :{data.Price}
                  </div>
                </div>
...
export const ComboServices = withTranslation()(
  connect(mapStateToProps, mapDispatchToProps)(ComboServicesClass)
);
