      ...
      <>
        ...
        <div className="service-navlink py-3">
          ...
          <TabContent activeTab={this.state.activeTab}>
            <TabPane tabId="1">
              {this.state.activeTab === "1" ? <AllServices /> : ""}
            </TabPane>
            <TabPane tabId="2">
              {this.state.activeTab === "2" ? <ComboServices /> : ""}
            </TabPane>
          </TabContent>
        </div>
      </>
...
export const ListService = withTranslation()(ListServiceClass);
