    ...
    return (
      <div className="view-detail container">
        ...
        <div className="view-detail-box p-4 d-flex flex-column">
          ...
          <TreatmentHistory id={this.props.match.params.id}>
            {t("")}
          </TreatmentHistory>
          {t("")}
        </div>
...
export const TreatmentDetailsPlus = withTranslation()(
  connect(mapStateToProps, mapDispatchToProps)(TreatmentDetailsPlusClass)
);
