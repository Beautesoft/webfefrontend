...
export class CartAppointmentClass extends Component {
  ...
  handleConfirmBooking = async () => {
    this.props.commonCreateApi(
      `itemcart/?Appointment_id=${this.props.match.params.id}`
    );
  };
...
export const CartAppointment = withTranslation()(
  connect(mapStateToProps, mapDispatchToProps)(CartAppointmentClass)
);
