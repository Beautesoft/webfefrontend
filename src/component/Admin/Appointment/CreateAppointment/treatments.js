...
export class TreatmentClass extends Component {
  ...
  handleSelect = async (id) => {
    await this.props
      .getTreatmentDetailList(`?Item_Deptid=${id}`)
      .then((res) => {
  ...
  handleTreatmentDetail = async (id) => {
    ...
    await this.props
      .getTreatmentDetail(`${id}/?Appointment_id=${appointmentDetail.id}`)
      .then(async (res) => {
  ...
  render() {
    ...
    let { treatmentResponse, appointmentDetail, detailField, t } = this.props;
    let { procedure, room_image, staff_image, treatment_details, Stock_PIC } =
      treatmentResponse;
          ...
          <div className="row">
            <div className="col-md-1 pr-0 position-relative">
              <div className="availability">
                <p className="heading">{t("Staff Availability")}</p>
                {list.map((data, index) => (
                  <>
                ...
                <div className="stepper">
                  <div className="step-view step-3">
                    <div className="timeline-view step d-flex justify-content-around">
                      <div className="">
                        <div className={``}>
                          <div className="timeline active"></div>
                        </div>
                ...
                <div className="appointment-holder">
                  <div className="treatment-section">
                    <NormalIf isShow={activeTab === "treatment"}>
                      <p className="treatment-label">{t("Treatments")}</p>
                      <div className="treatment-type">
                        {treatment.length > 0 &&
                          treatment.map((data, index) => (
                            <div
                              className="treatment mt-4 col-3"
                              onClick={() => this.handleSelect(data.id)}
                              key={index}
                            >
                              <img
                    ...
                    <NormalIf isShow={activeTab === "treatmentdetaillist"}>
                      ...
                      <div className="treatment-type">
                        {treatmentDetail.length > 0 &&
                          treatmentDetail.map((data, index) => (
                            <div
                              className="treatment mt-4 col-3"
                              onClick={() =>
                                this.handleTreatmentDetail(data.id)
                              }
                            >
                              <img
                                className="treatment-img"
                    ...
                    <NormalIf isShow={activeTab === "treatmentdetail"}>
                      <p className="treatment-label">
                        ...
                        <span>{t("Facial")}</span> {">"}{" "}
                        <span>{t("Golden facial")}</span>
                      </p>
                      <div className="treatment-detail row">
                        <div className="col-5 p-0">
                          <p className="headline">{t("Treatment details")}</p>
                          <p className="detail">{treatment_details} </p>
                          <p className="headline mt-3">{t("Products used")}</p>
                        ...
                        <div className="col-4 staff">
                          <div className="row m-0">
                            <div className="col-6 p-0">
                              <p className="headline">{t("Treatment room")}</p>
                              <img
                                onClick={() =>
                                  history.push(
                                    `/admin/appointment/create/treatment/${treatmentId}/view-rooms`
                                  )
                                }
                                className="treatment-img"
                                src={room_image}
                            ...
                            <div className="col-6 p-0">
                              <p className="headline">{t("Staff")}</p>
                              <img
                                onClick={() =>
                                  history.push(
                                    `/admin/appointment/create/treatment/${treatmentId}/view-staffs`
                                  )
                                }
                                className="treatment-img"
                                src={staff_image}
                            ...
                            <div className="procedure p-0">
                              <p className="headline">{t("Procedure")}</p>
                    ...
                    <NormalIf isShow={activeTab === "select-treatment"}>
                      {activeTab === "select-treatment" ? (
                        <div className="treatment-detail row">
                          ...
                          <TreatmentDetail
                            id={treatmentId}
                            handleBookTreatment={this.handleBookTreatment}
                          ></TreatmentDetail>
                        </div>
                      ) : (
                        ""
                    ...
                    <NormalIf isShow={activeTab === "confirm-booking"}>
                      <div className="treatment-detail row">
                        <AllAppointment
                          handleAnotherTreatment={this.handleAnotherTreatment}
                        ></AllAppointment>
                      </div>
                    </NormalIf>
                  </div>
