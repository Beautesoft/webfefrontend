...
export class BookAppointmentClass extends Component {
    ...
    list: [
      {
        emp_name: "MANDY YIN",
        job_title: "THERAPIST",
        value: "0 Appointment today",
        emp_img:
          "http://52.60.58.9:800//media/img/IMG-20200824-WA0000_pXUowT9.jpg",
        appointment: [],
        id: 14,
      },
      {
        ...
        value: "0 Appointment today",
        emp_img: "http://52.60.58.9:800//media/img/4._Users_RrMUlCB.png",
        appointment: [],
        id: 13,
      },
    ],
  ...
  handleConfirmBooking = async () => {
    ...
    history.push(
      `/admin/appointment/create/treatment/${this.props.match.params.id}/appointment-cart`
    );
  };
  ...
  render() {
    ...
    let { procedure, room_image, staff_image, treatment_details, PIC_Path } =
      treatmentResponse;
                ...
                <div className="appointment-holder">
                  <div className="treatment-section">
                    <NormalIf isShow={activeTab === "book-appointment"}>
                      <p className="treatment-label fs-14 f-600">
                        {t("Book appointment")}
                      </p>
                      <TreatmentList
...
export const BookAppointment = withTranslation()(
  connect(mapStateToProps, mapDispatchToProps)(BookAppointmentClass)
);
