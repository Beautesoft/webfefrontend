...
export class TreatmentConfirmClass extends Component {
  ...
  componentWillMount() {
    ...
    this.props
      .getSelectedTreatmentList(`?appt_id=${appointmentDetail.id}`)
      .then((res) => {
...
export const TreatmentConfirm = withTranslation()(
  connect(mapStateToProps, mapDispatchToProps)(TreatmentConfirmClass)
);
